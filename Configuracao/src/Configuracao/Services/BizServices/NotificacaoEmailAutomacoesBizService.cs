namespace GxpConfiguracao.Services.BizServices
{
	...
	public class NotificacaoEmailAutomacoesBizService : GxpBizService, INotificacaoMensagemBizService
	{
		...
		public NotificacaoEmailAutomacoesBizService(IParametroBizService parametroBizService1)
		{
		...
		public TipoNotificacao TipoSuportado
		{
			get
			{
				return TipoNotificacao.EmailAutomacoes;
			}
		}
